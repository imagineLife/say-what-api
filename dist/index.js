        ...
        Crud: class extends r {
          ...
          async remove() {
            try {
              ...
              throw (
                (console.log(`${this.collectionName} drop error`), new Error(e))
              );
            }
          }
        },
      ...
      e.exports = async function (e, t) {
        try {
          await s.MONGO_CLIENT.connect(),
            r.emit('DB_CONNECT', !0),
            t.status(200).send({
              MONGO_CONNECTED: s.MONGO_CLIENT.topology.s.state === 'connected',
            });
        } catch (e) {
    ...
    12: (e, t, o) => {
      ...
      e.exports = async function (e, t, o) {
        try {
          ...
          return (
            console.log('dbRes'), console.log(c), t.status(200).json('success')
          );
        } catch (e) {
          return (
